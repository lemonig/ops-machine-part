/*
 * @Author: Jonny
 * @Date: 2023-09-05 10:37:17
 * @LastEditors: Jonny
 * @LastEditTime: 2023-09-07 13:32:07
 * @FilePath: \ops-machine-part\src\app\routes\warehouse\alarm\alarm.component.ts
 */
...
export class AlarmComponent implements OnInit {
  ...
  getTableData() {
    ...
    this.loading = true;
    this._http.post('/api/notification/history/page', params).subscribe((res: any) => {
      this.loading = false;
      if (res.success) {
